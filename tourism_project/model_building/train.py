...
os.environ["HF_TOKEN"] = "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" # please use your token
# HF_TOKEN = os.getenv("HF_TOKEN")
api = HfApi(token=os.getenv("HF_TOKEN"))

# here you will be replacing with your datasets
Xtrain_path = "hf://datasets/ranjithkumarsundaramoorthy/tourism-project/Xtrain.csv"
Xtest_path  = "hf://datasets/ranjithkumarsundaramoorthy/tourism-project/Xtest.csv"
ytrain_path = "hf://datasets/ranjithkumarsundaramoorthy/tourism-project/ytrain.csv"
ytest_path  = "hf://datasets/ranjithkumarsundaramoorthy/tourism-project/ytest.csv"
...
tourism_csv = pd.read_csv("/content/tourism_project/data/tourism.csv")
df = tourism_csv
